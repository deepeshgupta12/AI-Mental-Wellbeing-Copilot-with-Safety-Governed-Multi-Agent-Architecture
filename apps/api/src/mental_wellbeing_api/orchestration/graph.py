...
from mental_wellbeing_api.agents.execution_finalize_agent import run_execution_finalize_agent
...
from mental_wellbeing_api.agents.support_mode_router_agent import run_support_mode_router_agent
...
def build_agent_runtime_graph():
    ...
    graph.add_edge("input_structuring", "intent_router")
