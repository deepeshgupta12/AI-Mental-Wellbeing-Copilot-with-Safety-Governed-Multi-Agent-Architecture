...
from mental_wellbeing_api.api.routes.admin_external_integrations import (
    router as admin_external_integrations_router,
)
...
from mental_wellbeing_api.api.routes.care_plans import router as care_plans_router
...
from mental_wellbeing_api.api.routes.external_integrations import (
...
from mental_wellbeing_api.api.routes.localization import router as localization_router
...
api_router.include_router(admin_external_integrations_router)
api_router.include_router(external_integrations_router)
