...
import { getAdminOpsOverview } from "@/lib/admin-api";
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
              {[
                ...
                { label: "Avg Intervention Rating", value: data.intervention_overview.avg_effectiveness_rating ?? "—" },
              ].map((item) => (
              ...
              <div className="rounded-lg border border-border bg-card p-4 shadow-card">
                ...
                <div className="space-y-3">
                  {data.latest_runtime_executions.length === 0 ? (
                    <div className="text-sm text-muted-foreground">No runtime executions available.</div>
                  ) : (
              ...
              <div className="rounded-lg border border-border bg-card p-4 shadow-card">
                ...
                <div className="space-y-3">
                  {Object.entries(data.intervention_overview.outcome_status_breakdown).length === 0 ? (
                    <div className="text-sm text-muted-foreground">No intervention outcomes available.</div>
                  ) : (
                    Object.entries(data.intervention_overview.outcome_status_breakdown).map(([key, value]) => (
