      ...
      >
        <motion.div variants={fadeIn} custom={0} className="mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">
            You've maintained your reflection streak for {streakDays} days. How is
            your energy now?
          </p>
        </motion.div>
          ...
          <div className="xl:col-span-2">
              ...
              <div className="flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    We were discussing your boundaries at work and how they relate
                    to your stress patterns...
                  </p>
                </div>
                <Link to="/app/chat">
            ...
            >
              ...
              <p className="text-xs text-muted-foreground mb-3">
                Based on your high stress and low sleep, today's plan is focused on
                Micro-Rest.
              </p>
